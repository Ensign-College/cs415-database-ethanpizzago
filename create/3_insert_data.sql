...
VALUES
    ...
    (3,'Billing'),
    (4,'Shipping');
ALTER SEQUENCE AddressType_address_type_id_seq RESTART WITH 5;
...
VALUES
    (1,1,'5555555555',CURRENT_TIMESTAMP,'1',1),
    (2,2,'5555555556',CURRENT_TIMESTAMP,'1',1),
    (3,1,'5555555555',CURRENT_TIMESTAMP,'1',1),
    (4,2,'5555555556',CURRENT_TIMESTAMP,'1',1);
ALTER SEQUENCE UserPhone_user_phone_id_seq RESTART WITH 5;

--UserInfo--
INSERT INTO UserInfo(user_info_id,web_user_id,profile_bio,profile_image_url,modified_date,created_date)
VALUES
    (1,1,'Main User (1): Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTYZ4AiSTOD6IbZ-zuTTghcjbMr15XMj1XSQ&s',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
    (2,2,'Willie Nelson (2): Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.','https://is1-ssl.mzstatic.com/image/thumb/Features125/v4/b4/c2/9a/b4c29a1e-3b45-2b60-be65-dbb96d21e42a/mza_1383128222591135178.png/375x375bb.jpg',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
